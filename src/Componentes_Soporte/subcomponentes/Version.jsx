...
export default function Version(props){
    ...
    const modificarEstadoVersion = async (version) => {
        ...
        try{
            const response = await (await axios.patch("https://modulo-soporte.onrender.com/version", change)).data;
    ...
    const modify = async (client_id) => {
        ...
        return (await axios.post("https://modulo-soporte.onrender.com/client/products", data)).data
    }
    ...
    return <>
            ...
            <HStack justifyContent="space-between">
                ...
                <ModalModify title={`Asociar cliente a version: ${version.number}`} 
