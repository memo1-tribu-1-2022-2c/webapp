...
export default function TicketSimplificado(props){
    ...
    {!done ? <FormControl>
      ...
      <RadioGroup onChange={setCriticidad} value={criticidad}>
        ...
        <Radio bg="white" value="SLA 1">SLA 1</Radio>
        <Radio bg="white" value="SLA 2">SLA 2</Radio>
        <Radio bg="white" value="SLA 3">SLA 3</Radio>
        <Radio bg="white" value="SLA 4">SLA 4</Radio>
        </Stack>
        </RadioGroup>
      <FormLabel marginTop="5%">Fecha de finalización del ticket</FormLabel>
      <Input
        bg="white"
        type="date"
    ...
    <ModalFooter justifyContent="space-between">
        {!done && <Button isLoading={loading} colorScheme="green" onClick={createTicket}>Crear ticket</Button>}
